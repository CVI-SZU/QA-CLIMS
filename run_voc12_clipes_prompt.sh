...
VQA_FG_CACHE=vqa/voc_vqa_fg_blip_clipes_prompt_ViT-L-14_cache.npy
VQA_BG_CACHE=vqa/voc_vqa_bg_blip_clipes_prompt_ViT-L-14_cache.npy
...
##### prepare vqa cache
CUDA_VISIBLE_DEVICES=6 python gen_text_feats_cache.py voc \
--clip ViT-L/14 \
...
--train_qa_clims_pass True --seed 2
